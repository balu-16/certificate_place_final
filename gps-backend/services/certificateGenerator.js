...
class CertificateGenerator {
  constructor() {
    // Use the PNG template from the public folder
    this.templatePath = path.join(__dirname, '../../public/certificates/template.png');
  }
  ...
  async generateCertificate(studentData) {
    try {
      ...
      // Read and embed the PNG template as background
      const templateImageBytes = await fs.readFile(this.templatePath);
